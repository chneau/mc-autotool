...
public class Throttler {
    ...
    /**
     * Staggers tasks based on the owner's hash code so that different modules
     * run their logic on different ticks, even if they use the same interval.
     * 
     * @param owner The object requesting the check (usually 'this').
     * @param interval How many ticks to wait between runs.
